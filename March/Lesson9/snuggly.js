// Desc: Prepare receipt for Snug Co //
//Author: Mo and Class
//Dates: Mar 11/25

//Define program constants //
const SNUG_COST_LOW = 21.99;
const SNUG_COST_MED = 21.99;
...
document.writeln("<tr>");
document.writeln(
  "<td colspan='2'>SNUGGLY COMPANY<br />Customer Purchase Receipt</td>"
);
document.writeln("</tr>");
...
document.writeln("<tr>");
//The percent format multiplies by 100 and puts the % at the end
